...
export const ROLE_PERMISSIONS = {
  ...
  LOCATION_MANAGER: [
    ...
    PERMISSIONS.VIEW_APPOINTMENTS, PERMISSIONS.CREATE_APPOINTMENT, PERMISSIONS.EDIT_APPOINTMENT, PERMISSIONS.DELETE_APPOINTMENT,
    // REMOVED: PERMISSIONS.VIEW_CLIENTS - Only Admins and Super Admins can access client management
    PERMISSIONS.CREATE_CLIENT, PERMISSIONS.EDIT_CLIENT, PERMISSIONS.DELETE_CLIENT,
